// main.js - Optimized Admin Review Deletion and Global Functions
        ...
        <div class="col-md-4 mb-4" id="doc-card-${doc.id}">
            <div class="card card-doc shadow-sm">
                <div class="card-body">
                    ...
                    <h5 class="doc-title" title="${doc.title}">${doc.title}</h5>
...
// HÀM TOGGLEAUTHPANEL ĐƯỢC CHUYỂN TỪ AUTH.JS SANG MAIN.JS
